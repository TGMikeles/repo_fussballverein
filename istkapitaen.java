 ...
 *
 */
public class istkapitaen {
	public static void main(String[] args) {
		int a =100000;
		try {

	 int zufalltriko =zufallD(99);
	

		

			//Erzeugen eines Files
			File file = new File("C:/Users/Ibrahim/Desktop/TestJava/istkapitean.sql");
			...
			for(int i=1;i<=100000;i++){
		     ...
		     System.out.println(zufalltriko);

				bw.write("insert into istkapitean(persnr,nummer,bezeichnung) values("+a+",'"+zufalltriko+",'Bezeichnung"
	...
	public static int zufallD(int anzahl) {
		return (int)Math.round(Math.random() * anzahl);
	}
