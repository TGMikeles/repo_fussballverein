...
public class cheftrainer {
	public static void main(String[] args) {
		try {
			...
			File file = new File("C:/Users/Ibrahim/Desktop/TestJava/cheftrainer.sql");
			...
			for(int i=1;i<=100000;i++){
				...
				bw.write("insert into cheftrainer(persnr,bezeichnung) values('Bezeichnung"+i+"',"+a+","+");"+System.getProperty("line.separator"));
						a+=2;
			}
