...
public class zeitraum {
	...
	public static void main(String[] args) {
		...
		try {
			...
			File file = new File("C:/Users/Ibrahim/Desktop/TestJava/zeitraum.sql");
			...
			for(int i=0;i<=100000;i++){
				...
				bw.write("insert into fanclub(name,sid,persnr,gegründet) values("+"'Name"+i+"',"+a+"',"+"'"+"'1996-01-01','2005-01-01'"+
