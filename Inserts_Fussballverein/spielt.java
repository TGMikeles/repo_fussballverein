...
public class spielt {
	public static void main(String[] args) {
		try {
			...
			File file = new File("C:/Users/Ibrahim/Desktop/TestJava/spielt.sql");
			...
			for(int i=0;i<=100000;i++){
				...
				bw.write("insert into spielt(persnr,bezeichnung) values('Bezeichnung"+i+"',"+a+","+randomInt+");"+System.getProperty("line.separator"));
						a+=2;
			}
