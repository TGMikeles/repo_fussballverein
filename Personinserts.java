...
public class Personinserts {
	public static void main(String[] args) {
		try {
			...
			File file = new File("C:/Users/Ibrahim/Desktop/TestJava/per.sql");
			...
			for(int i=100000;i<=1500000;i++){
				...
				bw.write("insert into person(persnr,vname,nname,geschlecht,gebdate) values("+i+",'"+randomGiv()+"',"+"'"+randomLas()+"','"+randomGe()+"'"+","+"'"+gc.get(gc.YEAR) + "-" + (gc.get(gc.MONTH) + 1) + "-" + gc.get(gc.DAY_OF_MONTH)+
